$(document).ready(function () {
  $('.selected__link').click(function () {
    ...
    if ($(this).text() === 'Thông Tin Sản Phẩm') {
      $('.content').append(`<p>Miêu tả: ÁO THUN FORM BOXY IN “TAKE TO HEART”.</p>
      ...
      $('.content').append(`<div class="card">
              <div class="card-body">
                <div class="d-flex flex-start align-items-center">
                  <img
                    ...
                    src="../img/img-avatar-1.png"
                    alt="avatar"
                    width="60"
                    height="60"
                  />
                  <div>
                    <h6 class="fw-bold text-primary mb-1">Chau Tiểu Long</h6>
                    <p class="text-muted small mb-0">Đã chia sẽ - 15/02/2023</p>
                  </div>
                </div>

                <p class="mt-3 mb-4 pb-2">
                  Tôi cảm thấy rất hài lòng với sản phẩm này. Luôn ủng hộ shop.
                </p>
              ...
              <div class="card-body">
                <div class="d-flex flex-start align-items-center">
                  <img
                    class="rounded-circle shadow-1-strong me-3"
                    src="../img/img-avatar-2.png"
                    alt="avatar"
                    width="60"
                    height="60"
                  />
                  <div>
                    <h6 class="fw-bold text-primary mb-1">Trần Tuấn Anh</h6>
                    <p class="text-muted small mb-0">Đã chia sẽ - 19/03/2023</p>
                  </div>
                </div>

                <p class="mt-3 mb-4 pb-2">
                  Chất lượng sản phẩm rất tốt. Giao hàng đúng thời hạn. Mức giá hợp lý.
                </p>
              ...
              <div class="card-body">
                <div class="d-flex flex-start align-items-center">
                  <img
                    class="rounded-circle shadow-1-strong me-3"
                    src="../img/img-avatar-3.png"
                    alt="avatar"
                    width="60"
                    height="60"
                  />
                  <div>
                    <h6 class="fw-bold text-primary mb-1">Nguyễn Thị Thanh Hằng</h6>
                    <p class="text-muted small mb-0">Đã chia sẽ - 15/04/2023</p>
                  </div>
                </div>

                <p class="mt-3 mb-4 pb-2">
                  Sản phẩm rất đẹp phù hợp với nhiều vóc dáng phụ nữ. Mức giá quá rẻ so với chất
                  lượng sản phẩm. Cực kỳ yêu thích mặt hàng này.
                </p>
              ...
              <div class="card-footer py-3 border-0" style="background-color: #f8f9fa">
                ...
                <div class="float-end mt-2 pt-1">
                  <button type="button" class="btn btn-primary btn-sm">Đăng tải</button>
